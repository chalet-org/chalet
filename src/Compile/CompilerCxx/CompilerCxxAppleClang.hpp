...
struct CompilerCxxAppleClang final : public CompilerCxxClang
{
	...
	static bool addSystemRootOption(StringList& outArgList, const BuildState& inState, const bool inQuotePaths);
	static bool addOsTargetOptions(StringList& outArgList, const BuildState& inState, const u32 inVersionMajorMinor);
