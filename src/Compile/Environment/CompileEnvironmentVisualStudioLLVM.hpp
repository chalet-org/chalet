...
#ifndef CHALET_COMPILE_ENVIRONMENT_VISUAL_STUDIO_LLVM_HPP
#define CHALET_COMPILE_ENVIRONMENT_VISUAL_STUDIO_LLVM_HPP
...
#endif // CHALET_COMPILE_ENVIRONMENT_VISUAL_STUDIO_LLVM_HPP
