...
private:
	std::string getSourceFile(const SourceFileGroup& inGroup, const std::string& inArch) const;
	StringList getCommand(CompileToolchain& inToolchain, const SourceFileGroup& inGroup, const std::string& inArch) const;
