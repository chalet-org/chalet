...
bool subprocess(const StringList& inCmd, const bool inCleanOutput = true, std::string inCwd = std::string());
std::string subprocessWithOutput(const StringList& inCmd, const bool inCleanOutput = true, std::string inCwd = std::string());
